...
def rollDice():
    ...
    if playerType == "player1":
        SERVER.sent(f"{value}player2Turn".encode())
    if playerType == "player2":
        SERVER.sent(f"{value}player1Turn".encode())
...
def gameWindow():
    ...
    global rollButton
    rollButton = Button(gameWindow,text="rollDice",fg="black",font=("Chalkboard SE",250,),bg="grey",command=rollDice,width=20,hieght=5)
    global playerTurn
    global playerType
    global playerName
